...
export function getLocalDemoDetail(auditId: string) {
  ...
  const evidences = [
    { id: 'local-ev-pdf', auditId: audit.id, originalFilename: 'solicitud_cancelacion_demo.pdf', safeFilename: 'solicitud_cancelacion_demo.pdf', mimeType: 'application/pdf', detectedMimeType: 'application/pdf', sizeBytes: 1450000, sha256: 'local-demo-pdf-sha256', storageBucket: 'local-demo', storageKey: null, status: 'STORED' as const, documentRole: 'EVIDENCE' as const, uploadedBy: localDemoUser.id, createdAt: now, updatedAt: now },
    { id: 'local-ev-img', auditId: audit.id, originalFilename: 'identificacion_demo.jpg', safeFilename: 'identificacion_demo.jpg', mimeType: 'image/jpeg', detectedMimeType: 'image/jpeg', sizeBytes: 850000, sha256: 'local-demo-img-sha256', storageBucket: 'local-demo', storageKey: null, status: 'STORED' as const, documentRole: 'EVIDENCE' as const, uploadedBy: localDemoUser.id, createdAt: now, updatedAt: now },
    { id: 'local-ev-audio', auditId: audit.id, originalFilename: 'llamada_retencion_demo.mp3', safeFilename: 'llamada_retencion_demo.mp3', mimeType: 'audio/mpeg', detectedMimeType: 'audio/mpeg', sizeBytes: 4200000, sha256: 'local-demo-audio-sha256', storageBucket: 'local-demo', storageKey: null, status: 'STORED' as const, documentRole: 'EVIDENCE' as const, uploadedBy: localDemoUser.id, createdAt: now, updatedAt: now },
  ];
